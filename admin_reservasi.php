    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <h2>Kelola Data Reservasi/Pemesanan
                            <label>
                                                        <a class='btn btn-info btn-xs hvr-icon-float-away ' href='admin_reservasi.php'>
                ...
                function form_k(){?>
                    <div class="col-md-5">
                        <div class="top-campaign">
                                    <h3 class="title-3 m-b-30">Data Detail 
                                        <a class='btn btn-info btn-xs hvr-icon-float-away' href='admin_reservasi.php'>
                                    ...
                                    <table class="table table-borderless table-striped table-earning table-responsive table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-right">Penumpang</td>
                                                <td style="text-align: center;">
                                                    <label>
                                                        <a class='btn btn-info btn-xs hvr-icon-float-away ' href='admin_reservasi.php?aksi=kelola'>
                                                            <i class='fa fa-eye'></i> 
                                                        </a>
                                                    </label>
                                                    <label>
