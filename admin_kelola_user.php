            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <h2>Kelola Data User
                            <label>
                                                        <a class='btn btn-info btn-xs hvr-icon-float-away ' href='admin_kelola_user.php'>
                                    ...
                                    <table class="table table-borderless table-striped table-earning table-responsive table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td>Sujono</td>
                                                <td class="text-right">989980084</td>
                                                <td class="text-right">Jl.Pahlawan Kerja No.100 Arengka Pangkal</td>
                                                <td class="text-right">jojo</td>
                                                <td class="text-right">sujonoganteng</td>
                                            ...
                                            <tr>
                                                <td>2</td>
                                                <td>Raihan</td>
                                                <td class="text-right">85645664563</td>
                                                <td class="text-right">Jl.Tambusai Ujung No. 31</td>
                                                <td class="text-right">rairai</td>
                                                <td class="text-right">raijutsu</td>
                                                <td style="text-align: center;">
                                                    <label>
                                                        <a class='btn btn-warning btn-xs hvr-icon-float-away ' href='admin_reservasi.php?aksi=kelola'>
                                                            <i class='fa fa-pencil-square-o'></i> 
                                            ...
                                            <tr>
                                                <td>3</td>
                                                <td>Romitos</td>
                                                <td class="text-right">944444084</td>
                                                <td class="text-right">Jl.Riau No.11</td>
                                                <td class="text-right">romi</td>
                                                <td class="text-right">romipinternget</td>
                                                <td style="text-align: center;">
                                                    <label>
                                                        <a class='btn btn-warning btn-xs hvr-icon-float-away ' href='admin_reservasi.php?aksi=kelola'>
                                                            <i class='fa fa-pencil-square-o'></i> 
                                            ...
                                            <tr>
                                                <td>4</td>
                                                <td>Sonias</td>
                                                <td class="text-right">98476332</td>
                                                <td class="text-right">Jl.Marimas Minum Limun</td>
                                                <td class="text-right">sonisoni</td>
                                                <td class="text-right">niacakep</td>
                                                <td style="text-align: center;">
                                                    <label>
                                                        <a class='btn btn-warning btn-xs hvr-icon-float-away ' href='admin_reservasi.php?aksi=kelola'>
                                                            <i class='fa fa-pencil-square-o'></i> 
                                            ...
                                            <tr>
                                                <td>5</td>
                                                <td>Pandawa</td>
                                                <td class="text-right">984535624</td>
                                                <td class="text-right">Jl.Arengka Ujung No. 32 Tangkerang</td>
                                                <td class="text-right">pandawa</td>
                                                <td class="text-right">pandawa32</td>
                                                <td style="text-align: center;">
                                                    <label>
                                                        <a class='btn btn-warning btn-xs hvr-icon-float-away ' href='admin_reservasi.php?aksi=kelola'>
                                                            <i class='fa fa-pencil-square-o'></i> 
                                            ...
                                            <tr>
                                                <td>6</td>
                                                <td>Sukriman</td>
                                                <td class="text-right">98934242344</td>
                                                <td class="text-right">Jl.Pangkal Pinang, no.2 Samping Ruko Biru</td>
                                                <td class="text-right">sukir</td>
                                                <td class="text-right">manganteng</td>
                                                <td style="text-align: center;">
                                                    <label>
                                                        <a class='btn btn-warning btn-xs hvr-icon-float-away ' href='admin_reservasi.php?aksi=kelola'>
                                                            <i class='fa fa-pencil-square-o'></i> 
